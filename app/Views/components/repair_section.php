<h2 class="text-4xl font-bold mb-12 border-b-2 border-accent-gold pb-2 inline-block"><?= lang('Text.repair.title') ?></h2>
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
    <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center">
        ...
        <h3 class="text-xl font-semibold mb-2"><?= lang('Text.repair.services.title') ?></h3>
        <ul class="list-none space-y-2 text-left">
            <li class="flex items-center text-sm">
                ...
                <?= lang('Text.repair.service1') ?>
            </li>
            <li class="flex items-center text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-blue-500 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M17 17h.01" />
                </svg>
                <?= lang('Text.repair.service2') ?>
            </li>
            <li class="flex items-center text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-blue-500 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M17 17h.01" />
                </svg>
                <?= lang('Text.repair.service3') ?>
            </li>
            <li class="flex items-center text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-blue-500 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M17 17h.01" />
                </svg>
                <?= lang('Text.repair.service4') ?>
            </li>
        </ul>
        <p class="text-gray-700 text-sm mt-4">
            <?= lang('Text.repair.objective') ?>
        </p>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center">
        ...
        <h3 class="text-xl font-semibold mb-2">Contactez-nous</h3>
        <p class="text-gray-700 text-sm">
            Besoin d'une réparation ou d'un devis ?<br>
            Notre équipe est à votre disposition.
        </p>
        <div class="mt-4">
            <a href="/fr/contact" class="inline-flex items-center px-4 py-2 bg-accent-gold text-white rounded-lg hover:bg-accent-gold/90 transition-colors">
