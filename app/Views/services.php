...
<?php
$this->setData([
    'pageTitle' => lang('Text.meta.title') . ' - ' . lang('Text.nav.services'),
        ...
        <div class="w-full flex flex-col justify-center items-center px-4 py-8 md:px-20 xl:px-80 md:py-20">
            <div class="w-full max-w-7xl text-center">
                ...
                <p class="text-xl text-gray-300 max-w-2xl mx-auto">
                    Nos services spécialisés pour l'art et la réparation
                </p>
            </div>
        </div>
    </header>
    ...
    <?= view_cell('App\Cells\ContainerCell::render', [
        'enfant' => '
            <div class="text-center">
                <p class="text-lg text-gray-600">Page services en développement...</p>
            </div>
        ',
        'bgColor' => 'bg-white'
    ]) ?>
