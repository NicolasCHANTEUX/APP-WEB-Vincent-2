...
('Pagaie Carbone Compétition 210 cm', 'pagaie-carbone-competition-210', 'Pagaie haut de gamme en carbone intégral avec finition mate, idéale pour la compétition et les longues distances.', 299.99, 0.65, '210cm', 'images/kayart_image1.png', 1, 10, 'PAG-CARB-COMP-210', 'new'),
('Pagaie Carbone Loisir 215 cm', 'pagaie-carbone-loisir-215', 'Pagaie en carbone légère et maniable, parfaite pour le loisir et les randonnées.', 249.99, 0.70, '215cm', 'images/kayart_image2.png', 1, 15, 'PAG-CARB-LOIS-215', 'new'),
('Pagaie Carbone Rivière 200 cm', 'pagaie-carbone-riviere-200', 'Pagaie renforcée spécialement conçue pour la rivière et les eaux vives.', 279.99, 0.75, '200cm', 'images/kayart_image3.png', 1, 12, 'PAG-CARB-RIV-200', 'new'),
('Paire de Pagaies Personnalisées', 'paire-pagaies-personnalisees', 'Paire de pagaies en carbone avec finition bleu métallique personnalisable.', 200.00, 1.40, '210cm (paire)', 'images/kayart_image2.png', 1, 1, 'PAG-PAIR-PERS', 'new'),
('Siège Kayak Ergonomique', 'siege-kayak-ergonomique', 'Siège ergonomique avec mousse haute densité pour un confort optimal.', 149.99, 1.20, '45cm x 35cm', 'images/default-siege.png', 2, 8, 'SIEG-ERGO-001', 'new');
